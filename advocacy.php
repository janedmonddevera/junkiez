...
<div class="h-100 w-100 d-flex justify-content-center align-items-center">
    ...
    <div class="col-12 col-md-6 m-0 p-0 "> 
            ...
            <div class="row z-n1 m-md-2 p-md-4 m-0 p-0 " style="min-height: 25vh;">
                <div class="col-12 col-md-12 m-0 p-0">
                   <div class="d-flex justify-content-start align-items-start h-100 w-100">
                ...
                <div class="col-12 col-md-12 m-0 p-0 d-md-block">
                <div class="d-flex justify-content-start align-items-start h-100 w-100">
    ...
    <div class="bg-light m-0 p-2 p-md-4 h5 md-h4 ">    
   ...
   <div class="col-12 col-md-8 m-0 p-0 "> <!-- 70% width on larger screens, full width on small screens -->
        ...
        <div class="row z-n1 m-0 p-0">
            <div class="col-12 col-md-6 m-0 p-0 ">
            <p class="d-flex justify-content-center align-items-center text-success font-weight-bolder h1 p-2">
           Contact Us.
       </p>
            <form class="p-md-4">
     <div class="form-row">
     ...
     <button class="button-57 h-100 w-100" type="submit" role="button"><span class="text">Send Email</span><span>Send Now</span></button>
