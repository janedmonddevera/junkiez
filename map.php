...
<div class="intro-home">
    ...
    <div class="col-12 col-md-12 m-0 p-0"> <!-- 30% width on larger screens, full width on small screens -->
        ...
        <p class="text-light h2 pt-md-4 pt-3">Trash to Cash</p>
        </div>
    </div>
    <div class=" d-flex justify-content-center align-items-center h-25 w-100">
    <div class="col-12 col-md-8 m-0 p-0  p-md-5 h-100  "> <!-- 70% width on larger screens, full width on small screens -->
        
            <img class="intro-image h-100 w-100 " src="<?php echo get_template_directory_uri(); ?>/assets/images/DSC09663.jpg;" alt="" style="aspect-ration:7/5;">
...
It is our duty to properly dispose of these waste if we want a better place for ourselves and the future generation so let’s aim for a greener Manila.
    ...
    <img class="intro-image h-100 w-100 "  alt="map" style="aspect-ratio:7/5;">
...
<div id="video" class="video" >
    <div class="h-100 d-flex justify-content-center align-items-center" > 
    <div class="blurred-background" style="   background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/denr.jpg;');"></div>
            <div class=" w-md-25 p-2 p-md-4 m-2 content-map  find-junk ">
             
                 <p class="text-light font-weight-bolder d-flex justify-content-center align-items-center" >WHAT HAPPENS WHEN YOU DON'T PRACTICE RIGHT MANAGEMENT ACCORDING TO THE LAW?</p>
<div class="d-flex justify-content-center align-items-center">
                 <button type="button" class="btn btn-success text-dark font-weight-bolder  " data-toggle="modal" data-target="#staticBackdrop">
    Click the gavel.
</button>
...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-xl  h-100 w-100">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">R.A 9003 - Solid Waste Act</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body m-0 p-0 h-100 w-100">
        <img class="h-100 w-100" src="<?php echo get_template_directory_uri(); ?>/assets/images/law.jpg" alt="">
      </div>
